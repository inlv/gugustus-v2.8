...
const vec3 streetColor = vec3(0.1, 0.5, 1.0);

const float fogDensity = 0.3;
const float fogDistance = 2.0;
const vec3 fogColor = vec3(1, 0.1, 0.4);

const float windowSize = 0.1;
const float windowDivergence = 1.5;
const vec3 windowColor = vec3(0.1, 0.2, 0.5);

const float beaconProb = 0.0006;
const float beaconFreq = 0.4;
const vec3 beaconColor = vec3(0.4, 0.2, 0.0);
